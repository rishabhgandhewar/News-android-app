...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public SearchAdapter(ArrayList<News> myDataset, Context context) {
    ...
    public SearchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_search_row, parent, false);
...
//        Picasso.get().load(image).resize(120, 140).into(holder.newsImage);
        ...
        holder.main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("fromBookmark", "No");
...
//                Picasso.get().load(news.getImage()).resize(120, 140).into(imageView);
                ...
                imageView1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String tweetUrl = "https://twitter.com/intent/tweet?text=Check out this link:&url=" + news.getUrl()+"&hashtags=CSCI571";
