...
public class TabPolitics extends Fragment {
    ...
    private final String url = "http://csci571-newsandroid.us-east-1.elasticbeanstalk.com/guardianPolitics";
    //    private final String url = "http://localhost:5000/guardian";
    String city;
    String state;
    String description;
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.tab_politics, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new HomeAdapter(newsItem, getContext(), 3);
