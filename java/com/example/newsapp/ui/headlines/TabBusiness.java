...
public class TabBusiness extends Fragment {
    ...
    private final String url = "http://csci571-newsandroid.us-east-1.elasticbeanstalk.com/guardianBusiness";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.tab_business, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new HomeAdapter(newsItem, getContext(), 2);
