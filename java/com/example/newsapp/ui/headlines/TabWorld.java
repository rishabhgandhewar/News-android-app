...
public class TabWorld extends Fragment {
    ...
    private final String url = "http://csci571-newsandroid.us-east-1.elasticbeanstalk.com/guardianWorld";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.tab_world, container, false);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter = new HomeAdapter(newsItem, getContext(), 1);
